...
/**
 * Class which create a member with a role (see enum TypeMember), first and last
 * name. This class also show the complete name of the member.
 * 
...
public class Member {
	...
	public Member(String firstName, String lastName, TypeMember roleEnum) {
	...
	public boolean equals(Object o) {
		...
		if (!firstName.equals(member.firstName))
			return false;
		if (!lastName.equals(member.lastName))
			return false;
	...
	public String toString() {
		return "Member{" + "firstName='" + firstName + '\'' + ", lastName='" + lastName + '\'' + ", role=" + role + '}';
	}

	// This is useless but need to keep for the moment (check ConsoleView)
	public enum TypeMember {
		FATHER, MOTHER, SON, DAUGHTER, CHILD, FRIEND, ADULT_MALE, ADULT_FEMALE
	}
