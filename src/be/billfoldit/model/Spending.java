...
/**
 * Class which create a spending based on a description and an amount. The
 * amount can be a round or unround value.
 * 
...
public class Spending {
	...
	public boolean equals(Object o) {
		...
		if (Double.compare(spending.amount, amount) != 0)
			return false;
	...
	public String toString() {
		...
		return type + "{" + "description='" + description + '\'' + ", amount=" + amount + '}';
	}
}
